...
export const StrategyLab: React.FC<StrategyLabProps> = ({ activeDocuments, meetingContext }) => {
  ...
  const handleSendEmail = async () => {
    ...
    try {
      ...
      const subject = `Strategic Sales Report: ${meetingContext.clientCompany} - Cognitive Sales Simulation`;
      const body = `
        <div style="font-family: sans-serif; color: #1e293b; max-width: 600px; margin: 0 auto;">
          ...
          <p style="font-size: 12px; color: #94a3b8; text-align: center;">Generated by Cognitive Sales Simulation Protocol</p>
        </div>
      `;
