             ...
             <div className="p-8 border-b border-slate-800 bg-slate-900/50 backdrop-blur-md">
                ...
                <div className="flex items-center justify-between">
                   <div className="flex items-center gap-6">
                      <div className="w-24 h-24 rounded-2xl overflow-hidden border border-slate-800 shadow-2xl relative group">
                         <AIAnimatedBot isAISpeaking={isAISpeaking} isUserListening={isUserListening} className="scale-75" />
                         <div className="absolute inset-0 bg-indigo-600/10 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center pointer-events-none">
                            <span className="text-[8px] font-black text-white uppercase tracking-widest bg-black/40 px-2 py-1 rounded-full">Neural Monitor</span>
                         </div>
                      </div>
